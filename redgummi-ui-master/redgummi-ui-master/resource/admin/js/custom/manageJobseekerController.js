admin.controller('manageJobseekerController', function($scope,$http,$location,$rootScope,callService) {
    ...
    $('#organisation').removeClass('active');
	  ...
	  $(".navbar-custom-menu").css('display', 'block');
		...
		// var jobSeekersService = "http://183.82.1.143:9060/admin/jobSeekers?period=" + days + "&moreInfo=true";
		var jobSeekersService = "http://183.82.1.143:9060/admin/jobSeekers?period=total&moreInfo=true";
