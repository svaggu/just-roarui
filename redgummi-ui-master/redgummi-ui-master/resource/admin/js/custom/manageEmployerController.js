admin.controller('manageEmployerController', function($scope,$http,$location,$rootScope,callService) {
    ...
    $('#organisation').removeClass('active');
	  ...
	  $(".navbar-custom-menu").css('display', 'block');
		...
		// var employerService = "http://183.82.1.143:9060/admin/recruiters?period=" + days + "&moreInfo=true";
		var employerService = "http://183.82.1.143:9060/admin/recruiters?period=total&moreInfo=true";
