	...
	if(user == "" || user == "empty" || user == undefined){
	  ...
	  $(".navbar-custom-menu").css('display', 'block');
		...
		$scope.getCount = function(days) {
			...
			var countJobsService = "http://183.82.1.143:9060/admin/jobs?period=" + days + "&moreInfo=true";
			...
			var countRecruitersService = "http://183.82.1.143:9060/admin/recruiters?period=" + days + "&moreInfo=false";
			...
			// count jobSeeker
			var countJobSeekerService = "http://183.82.1.143:9060/admin/jobSeekers?period=" + days + "&moreInfo=false";
			...
			// count jobAlerts
			var jobAlertsService = "http://183.82.1.143:9060/admin/jobAlerts?period=" + days + "&moreInfo=false";
